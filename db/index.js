...
async function createUser({ username, password, name, location }) {
  ...
  //users is the table the row is added to. 
  //(username, password, name, location) is a parameter identifying the columns that data will be inserted into. 
...
async function createPost({
  ...
  try {
    ...
    return await addTagsToPost(post.id, tagList);//createPost create post and tags and links them together
  } catch (error) {
    throw error;
  }
}
