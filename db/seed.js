...
async function createTables() {
    try {
        ...
        //a list of parameters defining each column, or attribute in the table and its data type
...
async function testDB() {
    try {
        ...
        const sandra = await getPostById(2);
        console.log("Result:", sandra);

        console.log("Calling createtag");
        const createTag = await createTags(["tag1", "tag2", "tag3"]);
        console.log("Result:", createTag)
...
rebuildDB()
    .then(testDB)
    .catch(console.error)
    .finally(() => client.end());//close out the client connection
